...
class TelegramNotifier:
    ...
    def format_summary(self, run_id: str, total: int, alerts: int, watchlist: int, rejected: int, report_path: str, health: list[dict] | None = None, performance_summary: dict | None = None, run_url: str = "", alert_candidates: list | None = None, watchlist_candidates: list | None = None) -> str:
        health = health or []
        ...
        market_health = [h for h in health if h.get("source") in {"DEX/DexScreener", "CEX/Binance", "CEX/OKXFallback", "MarketContext/Binance", "MarketContext/CoinGeckoFallback"}]
        ...
        header = (
            f"📊 <b>Crypto Alpha Engine v0.7.5</b>\n"
            f"Run: {esc(run_id)}\n"
