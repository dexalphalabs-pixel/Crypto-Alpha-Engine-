# Crypto Alpha Engine v0.7.7 Audit / Hotfix Notes
...
- Python compile smoke test: OK.
- RUN_MODE=performance smoke test: OK.
- Empty __pycache__ folders removed from release ZIP.


## Audyt v0.7.7

Najważniejsza zmiana: oddzielenie potencjału sygnału od jakości danych. `final_score` nie jest już jedynym filtrem. `HIGH_CONVICTION` wymaga `source_confidence=HIGH`, a `MOMENTUM_ALERT` minimum `MEDIUM`. To zmniejsza ryzyko alertów opartych o częściowe lub zdegradowane dane.
