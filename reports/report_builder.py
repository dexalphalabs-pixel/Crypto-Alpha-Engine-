...
<head>
  <meta charset="utf-8">
  <title>Crypto Alpha Engine v0.7.5 Report</title>
  <style>
...
<body>
  <h1>Crypto Alpha Engine v0.7.5 Report</h1>
  <div class="box">
...
class ReportBuilder:
    ...
    def _html_table(self, df: pd.DataFrame) -> str:
        ...
        columns = [
            ...
            "security_score", "event_risk_score", "data_quality_score", "unlock_risk_score", "final_score", "risk_score", "tags", "reasons", "risks", "url"
        ]
